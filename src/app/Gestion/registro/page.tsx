...
export default function RegistroPage() {
  ...
  // Pantalla final con botón corregido
  if (exito) {
    return (
    ...
    <div className={`min-h-screen flex font-poppins bg-gradient-to-b ${colorPrincipal}`}>
      ...
      <aside className={`${colorSidebar} text-white w-64 flex flex-col justify-between py-8 px-6`}>
        ...
        <button
          ...
          className="bg-white/20 text-white py-2 px-4 rounded-lg hover:bg-white/30 transition-all font-medium"
        >
          Salir
        </button>
      </aside>
      ...
      <main className="flex-1 bg-white p-10 rounded-tl-3xl shadow-inner overflow-y-auto">
        ...
        {/* Formulario */}
        <form onSubmit={handleSubmit} className="bg-white border border-gray-300 rounded-2xl shadow-2xl p-8">
